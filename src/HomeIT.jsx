...
export default function App() {
  return (
    <div>
      {/* STILI MODIFICATI SOLO PER MOBILE (< 768px). IL DESKTOP RESTA INVARIATO. */}
      <style>{`
        ...
        /* --- CLASSI DI SUPPORTO MOBILE --- */
        .mobile-nav { display: none; }
        
        @media (max-width: 768px) {
          /* Navbar Mobile: Stato iniziale TRASPARENTE */
          .navbar { 
          ...
          /* Navbar Mobile: STATO ALLO SCROLL (Blur + Ombra) */
          .navbar.scrolled {
            background: rgba(20, 25, 30, 0.75) !important; 
          ...
          /* LAYOUT SINISTRA: EDR + LOGHI IN RIGA */
          .mobile-nav-left {
            display: flex !important; 
            flex-direction: row !important; 
            align-items: center !important; 
            gap: 30px !important; /* SPAZIO LARGO tra EDR e icone */
          }
          .mobile-social-icons {
            display: flex !important; 
            flex-direction: row !important; 
            gap: 30px !important; /* SPAZIO LARGO tra le icone sociali */
            align-items: center !important;
          ...
          /* Hero (Centrare i bottoni e gestire i testi) */
          .hero h1 { 
            font-size: 42px !important; 
            line-height: 1.2 !important; 
            padding: 0 15px !important; /* Diamo un po' di margine anche al titolo */
          }
          .hero p { 
            font-size: 18px !important; 
            padding: 0 35px !important; /* Stringe il testo aggiungendo spazio ai lati */
            line-height: 1.5 !important; /* Aumenta lo spazio tra le righe se va a capo */
            box-sizing: border-box !important;
          }
          .hero-buttons-wrapper { 
            display: flex !important; flex-direction: column !important; 
            align-items: center !important; gap: 15px !important; margin-top: 30px !important;
          }
          ...
          /* Education Cards Mobile (Spazio maggiorato dal titolo e metadati) */
          .education-title { 
          ...
          .education-metadata span { 
            font-size: 13px !important; 
          }

          /* Skills e Contatti Grid Mobile */
          ...
          .mobile-menu-modal .close-btn:active {
...
function Navbar() {
  ...
  const isItalian = location.pathname === "/it" || location.pathname === "/"; // Presumo che questa sia la home IT
    ...
    <>
      ...
      <div className={`navbar ${scrolled ? "scrolled" : ""}`} style={{ zIndex: 9999 }}>
        ...
        <div className={`nav-left desktop-nav`} style={{ display: "flex", alignItems: "center", width: "100%", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <div className="nav-links">
              ...
              <a href="/CV_DeRocchiEmanuele.pdf" target="_blank" rel="noopener noreferrer" className="icon" style={{ display: "flex", alignItems: "center", gap: "6px" }}>
          ...
          <div className="nav-right" style={{ display: "flex", gap: "30px", alignItems: "center" }}>
            ...
            >
              <img src="https://flagcdn.com/it.svg" alt="Language" style={{ width: "24px", height: "24px", borderRadius: "50%", border: "2px solid white", objectFit: "cover" }} />
            </button>
          </div>
        </div>
        ...
        <div className="mobile-nav">
          ...
          <button
            style={{ background: "transparent", border: "none", color: "white", cursor: "pointer", padding: "0", opacity: 0.9, display: "flex", alignItems: "center", justifyContent: "center" }}
        ...
        <div className="mobile-menu-overlay" onClick={closeMenu}>
          <div className="mobile-menu-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="mobile-nav-links">
              <a href="#profile" onClick={closeMenu}>Profilo</a>
              <a href="#education" onClick={closeMenu}>Istruzione</a>
              <a href="#projects" onClick={closeMenu}>Progetti</a>
              <a href="#skills" onClick={closeMenu}>Competenze</a>
              <a href="#contact" onClick={closeMenu}>Contatti</a>
              <a href="/CV_DeRocchiEmanuele.pdf" target="_blank" rel="noopener noreferrer" onClick={closeMenu} style={{ display: "flex", alignItems: "center", gap: "8px", marginTop: "10px" }}>
                Curriculum <FiExternalLink size={18} />
              </a>
              <button 
                className="flag" 
                onClick={() => {
              ...
              >
                <img src="https://flagcdn.com/it.svg" alt="Language" style={{ width: "36px", height: "36px", borderRadius: "50%", border: "2px solid white", objectFit: "cover" }} />
              </button>
            </div>
          </div>
        </div>
  ...
  return (
    <div id="hero" className="hero" style={{ position: "relative" }}>
      ...
      <div className="hero-buttons hero-buttons-wrapper">
        <a href="#profile" className="btn" style={{ backgroundColor: "white", color: "black", padding: "14px 26px", fontSize: "18px", fontWeight: "500", border: "none", marginRight: "15px" }}>Di più su di me</a>
        <a
  ...
  return (
    <div id="profile" style={{ minHeight: "100vh", padding: "120px 80px", color: "white", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", gap: "20px" }}>
      ...
      <div className="responsive-profile-wrapper" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", width: "100%", paddingLeft: "300px", paddingRight: "120px" }}>
        ...
        {/* CONTAINER AGGIORNATO: Raggruppa le bolle centralmente e abilita i posizionamenti sfasati su mobile */}
        <div className="profile-bubbles-column" style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", width: "100%" }}>
          <div className="bubbles-container" style={{ marginRight: "300px", "--scroll-y": scrollY }}>
            ...
            <Bubble size="90px" top="35%" left="38%" fontSize="13px" text="Creatività" />
            <Bubble size="125px" top="35%" left="65%" fontSize="16px" text="Innovazione" />
            <Bubble size="145px" top="70%" left="35%" fontSize="17px" text={<>Valutazione <br />Rischi /<br />Opportunità</>} />
    ...
    <div id="education" style={{ minHeight: "100vh", padding: "120px 80px", color: "white", display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", width: "100%", maxWidth: "850px" }}>
        ...
        <RevealContainer delay={300}>
          <div className="hover-scale project-card" style={{ background: "linear-gradient(135deg, rgba(39,46,56,0.5), rgba(116,142,184,0.5))", backdropFilter: "blur(10px)", borderRadius: "24px", padding: "35px", border: "1px solid rgba(255,255,255,0.15)", boxShadow: "0 10px 30px rgba(0,0,0,0.15)" }}>
            <h3 className="project-title education-title" style={{ fontSize: "26px", margin: "0 0 15px 0" }}>BSc Ingegneria Gestionale</h3>
            <div className="education-metadata" style={{ display: "flex", gap: "30px", opacity: 0.9, fontSize: "15px", flexWrap: "wrap", marginBottom: "20px" }}>
